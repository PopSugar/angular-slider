...
(function() {
  var MODULE_NAME, SLIDER_TAG, angularize, contain, gap, halfWidth, hide, inputEvents, isInt, module, offset, offsetLeft, pixelize, qualifiedDirectiveDefinition, roundStep, show, sliderDirective, width;
  ...
  isInt = function(value) {
    var int;
    int = parseInt(value);
    return !isNaN(int) && int.toString().length === value.toString().length;
  };
